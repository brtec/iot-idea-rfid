...
function listhardware() {
    ...
    document.getElementById("spin").value = config.hardware.spin;
    document.getElementById("rgbrpin").value = config.hardware.rgbrpin;
    document.getElementById("rgbgpin").value = config.hardware.rgbgpin;
    document.getElementById("rgbbpin").value = config.hardware.rgbbpin;
    if (isOfficialBoard) {
...
function savehardware() {
    ...
    config.hardware.spin = parseInt(document.getElementById("spin").value);
    ...
    config.hardware.rgbrpin = parseInt(document.getElementById("rgbrpin").value);
    config.hardware.rgbgpin = parseInt(document.getElementById("rgbgpin").value);
    config.hardware.rgbbpin = parseInt(document.getElementById("rgbbpin").value);
    uncommited();
}
...
function testLedR() {
    websock.send("{\"command\":\"testledr\"}");
}
function testLedG() {
    websock.send("{\"command\":\"testledg\"}");
}
function testLedB() {
    websock.send("{\"command\":\"testledb\"}");
}
